...
export default function Dashboard({ data, onNavigate }) {
  ...
  // Donut chart calculations - optimized for inner spacing
  ...
  const strokeDashoffsetGDPR = outerCircumference - (92 / 100) * outerCircumference
  const strokeDashoffsetSOC2 = innerCircumference - (78 / 100) * innerCircumference
          ...
          <div className="flex-1 flex items-center justify-around flex-wrap gap-6">
            <div className="relative">
              <svg className="w-64 h-64 -rotate-90">
                ...
                <circle cx="128" cy="128" fill="transparent" r={96} stroke="#171c1f" strokeWidth={10}></circle>
                ...
                <circle cx="128" cy="128" fill="transparent" r={80} stroke="#171c1f" strokeWidth={10}></circle>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-xs text-on-surface-variant tracking-widest font-bold mt-1">AVG SCORE</span>
              </div>
            </div>
